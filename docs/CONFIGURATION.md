...
| Setting | Type | Default | Env Var |
|---------|------|---------|---------|
| `TRACING.ENABLED` | bool | `True` | `DJANGO_OBSERVABILITY_TRACING_ENABLED` |
...
| `TRACING.CONSOLE_EXPORTER` | bool | `False` | `DJANGO_OBSERVABILITY_CONSOLE_EXPORTER` |

### Logging

| Setting | Type | Default | Env Var |
|---------|------|---------|---------|
| `LOGGING.ENABLED` | bool | `True` | `DJANGO_OBSERVABILITY_LOGGING_ENABLED` |
...
| `LOGGING.OTLP_ENABLED` | bool | `True` | `DJANGO_OBSERVABILITY_LOG_OTLP_ENABLED` |
...
| Setting | Type | Default | Env Var |
|---------|------|---------|---------|
| `METRICS.PROMETHEUS_ENABLED` | bool | `True` | `DJANGO_OBSERVABILITY_PROMETHEUS_ENABLED` |
| `METRICS.PROMETHEUS_ENDPOINT` | str | `"/metrics"` | `DJANGO_OBSERVABILITY_PROMETHEUS_ENDPOINT` |
| `METRICS.OTLP_ENABLED` | bool | `False` | `DJANGO_OBSERVABILITY_METRICS_OTLP_ENABLED` |
| `METRICS.OTLP_ENDPOINT` | str | `"http://localhost:4317"` | `OTEL_EXPORTER_OTLP_ENDPOINT` |
| `METRICS.EXPORT_INTERVAL` | int | `60` | `DJANGO_OBSERVABILITY_METRICS_INTERVAL` |

### Celery

| Setting | Type | Default | Env Var |
|---------|------|---------|---------|
| `CELERY.ENABLED` | bool | `False` | `DJANGO_OBSERVABILITY_CELERY_ENABLED` |
| `CELERY.TRACING_ENABLED` | bool | `True` | `DJANGO_OBSERVABILITY_CELERY_TRACING_ENABLED` |
| `CELERY.LOGGING_ENABLED` | bool | `True` | `DJANGO_OBSERVABILITY_CELERY_LOGGING_ENABLED` |
| `CELERY.METRICS_ENABLED` | bool | `True` | `DJANGO_OBSERVABILITY_CELERY_METRICS_ENABLED` |

### Profiling

| Setting | Type | Default | Env Var |
|---------|------|---------|---------|
| `PROFILING.ENABLED` | bool | `False` | `DJANGO_OBSERVABILITY_PROFILING_ENABLED` |
