...
def test_setup_instrumentation_instruments_django():
    ...
    with (
        ...
        patch("django_observability.instrumentation.setup._instrument_database"),
        patch("django_observability.instrumentation.setup._instrument_cache"),
        patch("django_observability.instrumentation.setup._instrument_http_clients"),
    ):
